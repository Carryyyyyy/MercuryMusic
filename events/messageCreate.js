module.exports = (client, message) => {
    ...
    if (cmd && DJ.enabled && DJ.commands.includes(cmd.name)) {
        ...
        if (!message.member.roles.includes(roleDJ.id)) {
            return message.channel.send(`${message.author}, This command is set only for those with the ${DJ.roleName} role. ❌`);//Instagram: e.alper_carry / Discord: carry#0500 : If You Have Any Problem You Can Contact Me.
        }
    }
