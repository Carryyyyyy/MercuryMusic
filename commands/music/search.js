...
if (!args[0]) return message.channel.send(`${message.author}, Please enter a valid song name. ❌`);
        ...
        embed.setTimestamp();
        embed.setFooter('Developed By CARRY 💜', message.author.avatarURL({ dynamic: true }));
       ...
       collector.on('collect', async (query) => {
            ...
            try {
                ...
                return message.channel.send(`${message.author}, I can't join audio channel. ❌`);//Instagram: e.alper_carry / Discord: carry#0500 : If You Have Any Problem You Can Contact Me.
            }
