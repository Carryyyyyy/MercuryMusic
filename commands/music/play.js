...
if (!args[0]) return message.channel.send(`${message.author}, Write the name of the music you want to search. ❌`);
        ...
        await message.channel.send(`Your ${res.playlist ? 'Your Playlist' : 'Your Track'} Loading... 🎧`);//Instagram: e.alper_carry / Discord: carry#0500 : If You Have Any Problem You Can Contact Me.
