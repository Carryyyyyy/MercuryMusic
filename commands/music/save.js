module.exports = {
  ...
  if (!queue || !queue.playing) return message.channel.send(`${message.author}, There is no music currently playing!. ❌`);
        ...
        message.author.send(`Registered track: **${queue.current.title}** | ${queue.current.author}, Saved server: **${message.guild.name}** ✅`) .then(() => {
            ...
            message.channel.send(`${message.author}, Unable to send you private message. ❌`);//Instagram: e.alper_carry / Discord: carry#0500 : If You Have Any Problem You Can Contact Me.
        });
    },
};